...
source_plate_sheet = 'library_12'; # Composite Library 5 (Experiment 0163)
...
for n_rep in range(0,num_copies):   
    for n_seq in range(0,num_sequences):
        for n_pos in range(0,num_wells_to_use):
            ...
            counter_iso = set_counter(counter_iso,count_iso);
...
reagent_transfer_volume = [60]*reagent_count; # [100]*reagent_count; # [nL]                      
